...
LMs_ = [
    ...
    },
    {
        ...
        "models_names": ["gpt2"],
        "gpt2_model_name": "gpt2-medium",
        "gpt2_model_dir": "kelm/output/gpt2-medium/kelm-gpt2/",
        "tokenizer_dir": "pre-trained_language_models/gpt/gpt2-medium"
    },
    {
        "lm": "luke",
    ...
    },
    {
        ...
        "hfroberta_model_dir": "pre-trained_language_models/kepler",
    ...
    },
    {
        ...
        "models_names": ["hfroberta"],
        "hfroberta_model_name": "roberta-base",
        "hfroberta_model_dir": "kelm/output/roberta-base/kelm_full/",
        "tokenizer_dir": "roberta-base"
    },
    {
        "lm": "colake",
        "label": "colake",
        "models_names": ["colake"],
        "colake_model_dir": "pre-trained_language_models/colake/model.bin",
        "tokenizer_dir": "roberta-base"
    },
]
...
def run_experiments(
    ...
    for relation in relations:
        ...
        PARAMETERS = {
            ...
            "logdir": log_dir,
            "data_path": data_path,
            "full_logdir": os.path.join(log_dir,
...
def get_GoogleRE_parameters(data_path_pre="data/"):
    ...
    data_path_pre = os.path.join(data_path_pre, "Google_RE")
...
def get_ConceptNet_parameters(data_path_pre="data/"):
    ...
    data_path_pre = os.path.join(data_path_pre, "ConceptNet")
    data_path_post = ".jsonl"
    return relations, data_path_pre, data_path_post
...
def get_Squad_parameters(data_path_pre="data/"):
    relations = [{"relation": "test"}]
    data_path_pre = os.path.join(data_path_pre, "Squad")
    data_path_post = ".jsonl"
    return relations, data_path_pre, data_path_post
